...
export function LanguageToggle({
  ...
  return (
    <button
      ...
      className={`inline-flex h-9 items-center gap-2 whitespace-nowrap rounded-full border border-gray-200 bg-white px-3.5 text-xs font-semibold text-gray-700 shadow-sm transition hover:border-gray-300 hover:bg-gray-50 ${className}`}
